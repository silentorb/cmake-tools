...
macro(create_target target is_executable is_shared)
...
macro(add_project project_name)
  if (NOT MSVC)
    if (CMAKE_TOOLS_CPP_VERSION)
      set(CMAKE_CXX_STANDARD ${CMAKE_TOOLS_CPP_VERSION})
...
macro(add name)
  if (EXISTS ${CMAKE_CURRENT_LIST_DIR}/${name}/${name}.cmake)
...
macro(define_option option)
  if (${option})
    message("Setting ${option} to ${${option}} in ${CURRENT_TARGET}")
    add_definitions(-D${option}=${${option}})
  endif ()
endmacro()